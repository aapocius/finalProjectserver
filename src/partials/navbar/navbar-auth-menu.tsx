...
const NavbarAuthMenu: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography border={0.99} p="2px" borderColor="GrayText" borderRadius="3px" fontWeight="bold" fontSize="11px" color="#26e39f" sx={{ mr: 2, userSelect: 'none' }}>{user?.email.split('@')[0].toUpperCase()}</Typography>
